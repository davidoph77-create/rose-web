...
export default function App() {
  ...
  // Rose V10-014 - Agent Execution Orchestrator
  ...
  const analyserMessage = async () => {
    ...
    if (result.mode === "v10") {
      ...
      ajouterJournal(
        `V10-014 : ${summary.intent ?? "general"} / ${summary.selectedAgents.join(", ") || "aucun agent"} / ${summary.orchestratorSummary ?? "orchestration ex̩cut̩e"}`
      );
      parler(summary.text);
      setMessage("");
    }
